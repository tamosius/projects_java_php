...
webcam.set_api_url( 'save_photo.php' );
...
$(document).ready(function(){
    $('.add_member_left_sidebar #photo_button, .member_profile_left_sidebar #photo_button').click(function(){
        $(this).css('display', 'none');
        $('.add_member_left_sidebar #shoot_button, .member_profile_left_sidebar #shoot_button').css('display', 'block');
        $('.member_profile_left_sidebar #image, .add_member_left_sidebar #image').hide();
        $('.add_member_left_sidebar #photo_camera, .member_profile_left_sidebar #photo_camera').show(); /* turn on the camera */
        webcam.reset(); /* get ready camera for another photoshoot */
    });
    $('.add_member_left_sidebar #shoot_button, .member_profile_left_sidebar #shoot_button').click(function(){
        $(this).css('display', 'none');
        $('.add_member_left_sidebar #photo_button, .member_profile_left_sidebar #photo_button').css('display', 'block');
        take_snapshot();
			...
			//if (msg.match(/(http\:\/\/\S+)/)) {
				...
				document.getElementById('las').innerHTML = msg;
